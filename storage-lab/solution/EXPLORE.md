...
Vous avez écrit cette classe ce matin (LAB G1). Elle marche. Le problème du jour est différent : **comment quelqu'un d'autre l'installe et s'en sert ?**

Le code source ne change pas de la journée. Tout le travail est autour.
